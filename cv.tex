...
\position{Research Assistant at SLAI} % Your expertise/fields
...
\begin{itemize}
    ...
    \item \textbf{Robotics}: SLAM, VIO, EKF, ICP, Path Planning, Control
    \item \textbf{Deep Learning}: YOLO, ViT, RNN, GAN, VAE, Diffusion, LLM
    \item \textbf{Machine Learning}: GLM, SVM, PCA, XGBoost, HMM
    \item \textbf{Hardware}: Circuit Design, Soldering, CAD, 3D Printing
\end{itemize}
}
